...
// @get_bit:test_if_get_bit_return_zero => [La fonction get_bit ne retourne pas 0 lorsque la valeur du bit est celle-ci]
...
// @get_bit:test_if_get_bit_return_one => [La fonction get_bit ne retourne pas 1 lorsque la valeur du bit est celle-ci]
