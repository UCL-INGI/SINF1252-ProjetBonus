...
// @hex_to_int:hex_normal => la fonction ne renvoie pas les bonnes valeurs (42->2A, 19->13)
...
// @int_to_hex:int_normal => la fonction ne renvoie pas les bonnes valeurs (2A->42, 13->19)
